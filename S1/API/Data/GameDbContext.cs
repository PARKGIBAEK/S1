...
public class GameDbContext(DbContextOptions<GameDbContext> options) : DbContext(options)
{
	...
	public DbSet<auth_key> auth_keys { get; set; }
	public DbSet<user_account> user_accounts { get; set; }
	public DbSet<user_character> user_characters { get; set; }
	public DbSet<user_inventory> user_items { get; set; }
	public DbSet<item_weapon> item_weapons { get; set; }
	public DbSet<item_armor> item_armors { get; set; }
	public DbSet<item_accessory> item_accessories { get; set; }
