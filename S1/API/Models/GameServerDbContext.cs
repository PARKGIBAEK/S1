...
public partial class GameServerDbContext : DbContext
{
    private readonly IConfiguration _configuration;

    public GameServerDbContext(IConfiguration configuration)
    {
        _configuration = configuration;
    }

    public GameServerDbContext(DbContextOptions<GameServerDbContext> options, IConfiguration configuration)
        : base(options)
    {
        _configuration = configuration;
    }
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
    {
        if (!optionsBuilder.IsConfigured)
        {
            ...
            optionsBuilder.UseMySql(connectionString, Microsoft.EntityFrameworkCore.ServerVersion.Parse("10.4.22-mariadb"));
        }
    }
